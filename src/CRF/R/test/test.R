...
options = c('no_of_epochs' = 100, 'learning_rate' = 1, 'gibbs_sampling_rounds' = 5, training_method="contrasive_divergence", overlap_window_length = 5, crf_sequence_length=10)
  options = c('no_of_epochs' = 10, 'learning_rate' = 1, 'gibbs_sampling_rounds' = 5, training_method="forward_backward", overlap_window_length = 5, crf_sequence_length=10)
...
crf_tag(crf_test_file='../../../preprocessing/R/test/results/crf_feature_SDU082', crf_model_file='results/crf_all_model_contrasive_divergence_20epochs_1LR_10rounds_SDU082excluded', 
  	feature_list_file ='../feature_list_all', output_prediction_file='results/result_all_train_SDU082_test_voting', options) 
