...
#    labels=labels,crf_model_file = 'results/crf_all_model_cd_10epochs_1LR_10gibbs_15_len_0_overlap_SDU118_excluded_no_snr_ele_dist_spped_dummy', options)
...
crf_tag(crf_test_file='../../../preprocessing/R/test/results/crf_feature_all_15_seqLength_0_overlap_SDU118', crf_model_file='results/crf_all_model_cd_10epochs_1LR_10gibbs_15_len_0_overlap_SDU118_excluded_no_snr_ele_dist_spped', 
     feature_list_file ='../feature_list_all', output_prediction_file='results/result_all_train_SDU118_test_15_len_0_overlap_no_snr_ele_dist_speed', options) 
