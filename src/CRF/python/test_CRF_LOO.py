...
#reg_constants = [0.001,0.003,0.2, 0.0075]

reg_constants = [0.001, 0.025,0.0075, 0.01,0.5, 0.1, 1, 10]
#reg_constants = [0.01, 0.005, 0.002]
reg_constants = [0.001]
periods = [5]
crf_sequence_length= 15
sliding_window_length = 5
interval_length_in_sec = 15

# crf_sequence_lengths = [10, 12]
# sliding_window_lengths = [0,2]
